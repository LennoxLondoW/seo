...
// Enable GZip compression for the following content types
$allowedContentTypes = [
    'text/html',
    'text/css',
    'text/javascript',
...
if (isset($_SERVER['HTTP_ACCEPT_ENCODING']) && strpos($_SERVER['HTTP_ACCEPT_ENCODING'], 'gzip') !== false) {
    // Check the Accept header for content types
...
<head>
    ...
    <meta name="description"
        content="Explore top quality services and products at Kodeal business enterprise. Let the most qualified staff serve you.">
    <meta property='og:site_name' content='KoDeal'>
    <meta property='og:type' content='website'>
    <meta property='og:title' content='KoDeal Site'>
    <meta property='og:description'
        content='Explore top quality services and products at Kodeal business enterprise. Let the most qualified staff serve you.'>
    <meta property='og:url' content='https://www.kodeal.com/'>
    <link rel='canonical' href='https://www.kodeal.com/'>
    <!--/google-fonts -->
    <link href="https://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
    <!--//google-fonts -->
    <!-- Template CSS -->
    <link rel="stylesheet" href="assets/css/style-starter.css?v=1.1">
</head>
            ...
            <nav class="navbar navbar-expand-lg navbar-light stroke py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    ...
                    <ul class="navbar-nav search-right mt-lg-0 mt-2">
                        ...
                        <li class="nav-item mx-lg-4"><a href="#link"
                                class="phone-btn btn-white d-none d-lg-block btn-style ms-2"><span
                                    class="fas fa-user me-2" aria-hidden="true"></span> User Login</a></li>
                    </ul>
                    ...
                    <div class="container">
                        <div class="banner-info">
                            ...
                            <div class="banner-info-top">
                                ...
                                <a href="about.html" class="btn btn-style btn-outline-light mt-sm-5 mt-4">More on Kodeal
                                    <span class="fas fa-angle-double-right ms-2"></span> </a>
                            </div>
                        </div>
        ...
        <div class="container-fluid mx-lg-0">
            <div class="row pt-sm-0 pt-5">
                <div class="col-lg-4 col-sm-6 mt-sm-0 m px-md-0 w3-gridhny-1 position-relative">
                    <div class="grids3-info">
                        <a href="#" class="d-block zoom">
                            <img src="assets/images/webp/g1.webp" alt="koDeal" class="img-fluid news-image">
                        </a>
                ...
                <div class="col-lg-4 col-sm-6 mt-sm-0 px-md-0 w3-gridhny-1 position-relative">
                    <div class="grids3-info">
                        <a href="#blog" class="d-block zoom">
                            <img src="assets/images/webp/g2.webp" alt="koDeal" class="img-fluid news-image"></a>
                ...
                <div class="col-lg-4 col-sm-6 mt-lg-0 px-md-0 w3-gridhny-1 position-relative">
                    <div class="grids3-info">
                        <a href="#blog" class="d-block zoom">
                            <img src="assets/images/webp/g3.webp" alt="koDeal" class="img-fluid news-image"></a>
                        <div class="w3-grids3-info">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="w3shape position-relative">
                            <img srcset="assets/images/webp/ab1.webp 480w,assets/images/webp/ab2.webp" alt=""
                    ...
                    <style>
                        .my-bg {
                            background-image: url(assets/images/webp/ab1.webp);
                        ...
                        @media screen and (min-width: 481px) {
                            .my-bg {
                                background-image: url(assets/images/webp/ab2.webp);
                            }
                        }
                    </style>
                    <div class="col-lg-6 mt-lg-0 mt-md-5 mt-4 align-self ps-lg-5 my-bg">
                        ...
                        <div class="w3l-two-buttons">
                            <a href="about.html" class="btn btn-style btn-primary mt-lg-5 mt-4">More on Kodeal <span
                                    class="fas fa-angle-double-right ms-2"></span></a>
                            <a href="#view" class="btn btn-outline-primary btn-style mt-lg-5 mt-4 ms-2"> Contact Us<span
                                    class="fas fa-angle-double-right ms-2"></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mt-5">
                    <div class="grid-block text-center">
                        <a href="#blog" class="d-block p-lg-4 p-3">
                            ...
                            <p class="">Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula.
                            </p>
                        </a>
                    </div>
                </div>
            ...
            <div class="container py-lg-5">
                <div class="row cwp23-content mt-lg-5 mt-4">
                    <div class="col-lg-6 cwp23-img">
                        ...
                        <p class="mt-4">Sed in metus libero. Sed volutpat eget dui ut tempus. Fusce fringilla tincidunt
                            laoreet
                            Morbi ac metus vitae diam scelerisque malesuada eget eu mauris.Cras varius lorem ac velit
                            pharetra.

                        </p>

                        <div class="w3l-button mt-lg-5 mt-4">
                            <a href="services.html" class="btn btn-style btn-primary mt-2">More on Kodeal <span
                                    class="fas fa-angle-double-right ms-2"></span></a>
                        </div>
                    </div>
                    <div class="col-lg-6 cwp23-text mt-lg-0 mt-5 ps-lg-5">
                        <div class="cwp23-text-cols">
                            <div class="column">
                                <a href="#">
                                    <img src="assets/images/webp/g2.webp" alt="koDeal"
                                        class="radius-image img-fluid"></a>
                            </div>
                            <div class="column">
                                <a href="#"><img src="assets/images/webp/g3.webp" alt="koDeal"
                                        class="radius-image img-fluid"></a>
                            </div>
                            <div class="column">
                                <a href="#"><img src="assets/images/webp/g4.webp" alt="koDeal"
                                        class="radius-image img-fluid"></a>
                            </div>
                            <div class="column">
                                <a href="#"><img src="assets/images/webp/g5.webp" alt="koDeal"
                                        class="radius-image img-fluid"></a>
                            </div>
            ...
            <div class="w3l-project p-md-5 p-4 px-4">
                <div class="row py-lg-4 px-lg-2 align-items-center">
                    <div class="col-lg-8 w3l-project-right">
                        <div class="bottom-info">
                            <div class="header-section pr-lg-5">
                                <h3 class="title-w3l two">Request Free Consultation <br>and <span class="span-bold">Lets
                                        Do It!</span>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 w3l-project-left mt-lg-0 mt-4">
                        <a href="#" class="btn btn-secondary btn-style"> Request Now <span
                                class="fas fa-angle-double-right ms-2"></span></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 pe-lg-5 mb-lg-0 mb-5">
                    <div class="w3l-header-sec text-left mb-md-5 mb-4">
                        ...
                        <h5 class="">Company that believes in the power of <span class="span-bold">creative
                                strategy</span></h5>
                        ...
                        <a href="services.html" class="btn btn-primary btn-style mt-lg-5 mt-4"> More on Kodeal <span
                                class="fas fa-angle-double-right ms-2"></span></a>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    <blockquote>
                                        <q><i class="fas fa-quote-left"></i> Lorem ipsum dolor sit amet consectetur
                                            adipisicing elit. Velit beatae
                                            laudantium
                                            voluptate rem ullam dolore nisi voluptatibus esse quasi, doloribus tempora.
                                            Dolores molestias adipisci dolor sit amet!.</q>
                                    </blockquote>
                                    <div class="testi-des">
                                        <div class="test-img"><img src="assets/images/webp/team1.webp" class="img-fluid"
                                                alt="client-img">
                                        </div>
                        ...
                        <div class="col-lg-6 item">
                            <div class="testimonial-content">
                                <div class="testimonial">
                                    ...
                                    <div class="testi-des">
                                        <div class="test-img"><img src="assets/images/webp/team2.webp" class="img-fluid"
                                                alt="client-img">
                                        </div>
                                        <div class="peopl align-self">
                                            <h3>Julia sakura</h3>
        ...
        <div class="footer-29 py-5">
            <div class="container py-lg-4">
                <div class="row align-items-center mb-3">
                    <h2 class="sign-left col-lg-7"> Join our community by using our services and grow your business.
                    </h2>
                    <div class="footerw3-btn col-lg-5 ps-lg-5"><a href="#" class="btn btn-secondary btn-style"> Try it
                            For Free <span class="fas fa-angle-double-right ms-2"></span></a></div>
                </div>
                ...
                <div class="row footer-top-29 mt-md-5 mt-4">
                    <div class="col-lg-4 col-md-6 footer-list-29 footer-1 pe-lg-5">
                        ...
                        <div class="footer-listw3-grids">
                            <p class="pe-lg-4">Lorem ipsum dolor sit amet consectetur ipsum amet elit.Sit amet
                                consectetur ipsum amet,Lorem ipsum dolor sit amet. </p>
                            <div class="w3pt-call-box mt-4">
                                <div class="w3pt-call-info">
                                    <h5>Get Us Support</h5>

                                    <h5><a href="tel:+1(21) 234 557 456"><i class="fas fa-phone-alt me-1"></i> +1(21)
                                            234 557 456</a></h5>
                                    <h5><a href="tel:+1(21) 234 4568"><i class="far fa-envelope me-1"></i> <a
                                                href="mailto:support@mail.com" class="mail"> support@mail.com</a></a>
                                    </h5>
